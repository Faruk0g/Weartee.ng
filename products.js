const PRODUCTS = [
    ...
    { name: "Backless Top(black)", price: 10000, img: "images/Backless Top(black).JPG", stock: 10, cat: "basic tops", isNew: true },
    ...
    { name: "Black V-neck Short Sleeve Basic Top", price: 10000, img: "images/Black V-neck Short Sleeve Basic Top.JPG", stock: 10, cat: "basic tops", isNew: true },
    ...
    { name: "Blue Tee", price: 10000, img: "images/Leopard Print Roundneck.JPG", stock: 10, cat: "tee", isNew: true },
    { name: "Blue Velvet Joggers", price: 10000, img: "images/Blue Velvet Joggers.JPG", stock: 10, cat: "joggers", isNew: true },
    { name: "Blue Wide leg Pant", price: 10000, img: "images/Blue Wide Leg Pant.JPG", stock: 10, cat: "pant", isNew: true },
    { name: "Brown Tank Top", price: 10000, img: "images/Brown Tank Top.JPG", stock: 10, cat: "basic tops", isNew: true },
    { name: "Brown Velvet Joggers", price: 10000, img: "images/Brown Velvet Joggers.JPG", stock: 10, cat: "joggers", isNew: true },
    { name: "Cream Color Tee", price: 10000, img: "images/Cream Color Tee.JPG", stock: 10, cat: "tee", isNew: true },
    ...
    { name: "Khaki Shirt", price: 10000, img: "images/Khaki Button-up Shirt (2).JPG", stock: 10, cat: "tee", isNew: true },
    { name: "Khaki Shirt", price: 10000, img: "images/Khaki Button-up Shirt.JPG", stock: 10, cat: "tee", isNew: true },
    ...
    { name: "Linen Free Pant(grey)", price: 10000, img: "images/Linen Free Pant (grey).JPG", stock: 0, cat: "pant", isNew: true },
    { name: "Linen Free Pant(black)", price: 10000, img: "images/Linen Free Pant(black).JPG", stock: 0, cat: "pant", isNew: true },
    { name: "Linen Free Pant(brown)", price: 10000, img: "images/Linen Free Pant(brown).JPG", stock: 10, cat: "pant", isNew: true },
    { name: "Linen Free Pant(caramel)", price: 10000, img: "images/Linen Free Pant(caramel).JPG", stock: 10, cat: "pant", isNew: true },
    ...
    { name: "Longsleeve Wrap Top(pink)", price: 12000, img: "images/Long Sleeve Wrap Top(pink).JPG", stock: 10, cat: "basic tops", isNew: true },
    { name: "Longsleeve Wrap Top", price: 10000, img: "images/Long Sleeve Wrap-Top.JPG", stock: 10, cat: "basic tops", isNew: true },
    ...
    { name: "Short Basic Top(black)", price: 10000, img: "images/Short Basic Top(black).JPG", stock: 10, cat: "basic tops", isNew: true },
    { name: "Short Basic Top(grey)", price: 10000, img: "images/Short Basic Top(grey).JPG", stock: 10, cat: "basic tops", isNew: true },
    { name: "Short Basic Top(pink)", price: 10000, img: "images/Short Basic Top(pink).JPG", stock: 10, cat: "basic tops", isNew: true },
    { name: "U Neck Basic Top", price: 15000, img: "images/U NEck Basic Top.JPG", stock: 10, cat: "basic tops", isNew: true },
    ...
    { name: "Velvet Joggers(burgundy)", price: 15000, img: "images/Velvet Joggers(burgundy).JPG", stock: 10, cat: "joggers", isNew: true },
    { name: "White Button-up Shirt", price: 15000, img: "images/White Button-up Shirt.JPG", stock: 10, cat: "tee", isNew: true },
    { name: "White Plain Tee", price: 10000, img: "images/White Plain Tee.JPG", stock: 10, cat: "tee", isNew: true },
