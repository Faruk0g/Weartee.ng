...
const PRODUCTS = [
    ...
    { name: "Black Graphic Tee", price: 10000, img: "images/Black Graphics Tee.JPG", stock: 1, cat: "tee", isNew: true },
    ...
    { name: "Black Straless Cap", price: 15000, img: "images/Black Strapless Cap.JPG", stock: 1, cat: "snapback", isNew: true },
    { name: "Black Straless Cap", price: 15000, img: "images/Black Strapless Cap (2).JPG", stock: 1, cat: "snapback", isNew: true },
    { name: "Black Straless Cap", price: 15000, img: "images/Black Strapless Cap (3).JPG", stock: 1, cat: "snapback", isNew: true },
    { name: "Black Tee", price: 15000, img: "images/Black Tee (2).JPG", stock: 1, cat: "tee", isNew: true },
    { name: "Black Tee", price: 10000, img: "images/Black Tee.JPG", stock: 1, cat: "tee", isNew: true },
    { name: "Blue Strapless Cap", price: 15000, img: "images/Blue Strapless Cap (2).JPG", stock: 1, cat: "snapback", isNew: true },
    { name: "Blue Strapless Cap", price: 15000, img: "images/Blue Strapless Cap.JPG", stock: 1, cat: "snapback", isNew: true },
    ...
    { name: "Blue Wide leg Pant", price: 8500, img: "images/Blue Wide Leg Pant.JPG", stock: 10, cat: "pant", isNew: true },
    ...
    { name: "Grey Tank Top", price: 7000, img: "images/Grey Tank Top.JPG", stock: 1, cat: "tee", isNew: true },
    { name: "Grey Tee", price: 15000, img: "images/Grey Tee.JPG", stock: 10, cat: "basic tops", isNew: true },
    { name: "Basic Top", price: 10000, img: "images/Heart Shaped Basic Top(lotus).JPG", stock: 1, cat: "basic tops", isNew: true },
    { name: "Basic Top(pink)", price: 10000, img: "images/Heart Shaped Basic Top(pink).JPG", stock: 1, cat: "basic tops", isNew: true },
    { name: "Khaki Shirt", price: 15000, img: "images/Khaki Button-up Shirt (2).JPG", stock: 1, cat: "tee", isNew: true },
    { name: "Khaki Shirt", price: 15000, img: "images/Khaki Button-up Shirt.JPG", stock: 1, cat: "tee", isNew: true },
    ...
    { name: "Longoff Shoulder Top(grey)", price: 10000, img: "images/Long Off Shoulder Top(grey).JPG", stock: 0, cat: "basic tops", isNew: true },
    { name: "Longoff Shoulder Top(red)", price: 10000, img: "images/Long Off Shoulder Top(red).JPG", stock: 0, cat: "basic tops", isNew: true },
    { name: "Longsleeve Basic Top", price: 10000, img: "images/Long Sleeve Basic Top.JPG", stock: 1, cat: "basic tops", isNew: true },
    { name: "Longsleeve Basic Top(brown)", price: 10000, img: "images/Long Sleeve Basic Top(brown).JPG", stock: 1, cat: "basic tops", isNew: true },
    { name: "Longsleeve Button-up Shirt(black)", price: 20000, img: "images/Long Sleeve Button-up Shirt(black).JPG", stock: 1, cat: "tee", isNew: true },
    { name: "Longsleeve Button-up Shirt(brown)", price: 20000, img: "images/Long Sleeve Button-up Shirt(brown).JPG", stock: 1, cat: "tee", isNew: true },
    { name: "Longsleeve Graphics Tee", price: 20000, img: "images/Long Sleeve Graphics Tee.JPG", stock: 1, cat: "tee", isNew: true },
    { name: "Longsleeve Graphics Tee(brown)", price: 20000, img: "images/Long Sleeve Graphics Tee(brown).JPG", stock: 1, cat: "tee", isNew: true },
    { name: "Longsleeve Graphics Tee(wine)", price: 20000, img: "images/Long Sleeve Graphics Tee(wine).JPG", stock: 1, cat: "tee", isNew: true },
    { name: "Longsleeve Wrap Top(black stripe)", price: 12000, img: "images/Long sleeve Wrap Top (black stripe).JPG", stock: 1, cat: "basic tops", isNew: true },
    ...
    { name: "Longsleeve Wrap Top", price: 12000, img: "images/Long Sleeve Wrap-Top.JPG", stock: 1, cat: "basic tops", isNew: true },
    { name: "Mesh Top", price: 8000, img: "images/Mesh Top.JPG", stock: 1, cat: "basic tops", isNew: true },
    { name: "Mesh Top", price: 8000, img: "images/Mesh Top (2).JPG", stock: 1, cat: "basic tops", isNew: true },
    { name: "Mesh Top", price: 8000, img: "images/Mesh Top (3).JPG", stock: 1, cat: "basic tops", isNew: true },
    { name: "Mesh Top", price: 8000, img: "images/Mesh Top (4).JPG", stock: 1, cat: "basic tops", isNew: true },
    ...
    { name: "One Piece Black Tee", price: 15000, img: "images/One Piece Black Tee.JPG", stock: , cat: "tee", isNew: true },
    ...
    { name: "Ripped Top(purple)", price: 10000, img: "images/Ribbed Top(purple).JPG", stock: , cat: "basic tops", isNew: true },
    ...
    { name: "Unisex Cargo(black)", price: 15000, img: "images/Unisex Cargo(black 2).JPG", stock: 1, cat: "pant", isNew: true },
    { name: "Unisex Cargo(black)", price: 15000, img: "images/Unisex Cargo(black).JPG", stock: 1, cat: "pant", isNew: true },
    { name: "Unisex Cargo(green)", price: 15000, img: "images/Unisex Cargo(green) (2).JPG", stock: 1, cat: "pant", isNew: true },
    { name: "Unisex Cargo(green)", price: 15000, img: "images/Unisex Cargo(green).JPG", stock: 1, cat: "pant", isNew: true },
    ...
    { name: "White Button-up Shirt", price: 15000, img: "images/White Button-up Shirt.JPG", stock: , cat: "tee", isNew: true },
    { name: "White Plain Tee", price: 10000, img: "images/White Plain Tee.JPG", stock: 0, cat: "tee", isNew: true },
    { name: "V-neck Shortsleeve Basic Top(yellow)", price: 9000, img: "images/Yellow V-neck Short Sleeve Basic Top.JPG", stock: 1, cat: "basic tops", isNew: true },
